...
class FormSellActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        photo.setOnClickListener {
            ...
            if (arePermissionsGranted(necessaryPermissions)) {
                easyImage.openCameraForImage(this@FormSellActivity)
            } else {
    ...
    private fun createProgressDialog(title: String): AlertDialog {
        ...
        text.text = title
        val builder = AlertDialog.Builder(this@FormSellActivity)
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        ...
        if (requestCode == CHOOSER_PERMISSIONS_REQUEST_CODE && grantResults.size > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            easyImage.openChooser(this@FormSellActivity)
    ...
    private fun requestPermissionsCompat(permissions: Array<String>, requestCode: Int) {
        ActivityCompat.requestPermissions(this@FormSellActivity, permissions, requestCode)
    }
